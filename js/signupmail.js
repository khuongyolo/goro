function EnglishChange(){
    ...
    document.getElementById("signup-mail-heading").innerHTML = "Sign-Up with Email";
    document.getElementById("signup-mail-label").innerHTML = "Mail Address";
...
function JapaneseChange(){
    ...
    document.getElementById("signup-mail-heading").innerHTML = "Emailで登録";
    document.getElementById("signup-mail-label").innerHTML = "Emailアドレス";
