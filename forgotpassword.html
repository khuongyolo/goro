...
<body>
	<div class="upper-container">
		<div class="logo-and-pic">
			...
			<img src="request.png" alt="demo-pic" id="left-img" width="120">
		</div>
		...
		<div class="forgot-password-container">
			<form> 
				...
				<label for="password" class="forgot-password-label" id="forgot-password-password-label">Mật khẩu mới</label>
				<div class="forgot-password-input-password-icon">
					<input type="password" id="user-new-password" name="user-password" class="new-password-input forgot-password-user-input" placeholder="goro123ABC">
				</div>
                <label for="password" class="forgot-password-label" id="forgot-password-re-password-label">Nhập lại mật khẩu</label>
				<div class="input-password-icon">
					<input type="password" id="user-re-new-password" name="user-password" class="new-password-input forgot-password-user-input" placeholder="goro123ABC">
				</div>
                <div class="check-box">
